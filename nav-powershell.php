				<div id="side-menu">
					...
					<ul>
						...
						<li><a href="powershell.php<?=$suffix?>#network"><i class="fa fa-globe fa-fw"></i> <?=$network?></a></li>
						<li><a href="powershell.php<?=$suffix?>#processes"><i class="fa fa-list-ol fa-fw"></i> <?=$processes?></a></li>
					</ul>
				</div>
