...
<head>
	...
	console, terminal, shell, interpreter, prompt, cli,
	command-line interface, command line interface, command-line interpreter, command line interpreter, command-line, command line,
	bash, command prompt, ms-dos prompt, dos prompt, command.com, cmd.exe, powershell,
	gnu linux, linux, windows, dos, ms-dos, pc-dos, freedos, dosbox,
	wiersz poleceń, konsola, powłoka, tryb ms-dos,
	interfejs wiersza poleceń, interpreter wiersza poleceń"/>
</head>
